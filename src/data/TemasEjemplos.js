...
export const TemasEjemplosData = [
    {
        ...
        contenidoPractico: [
            ...
            },
            {
                ...
                id: 2,
                data: {
                    imagenes: [azusa, seedbornmuse, fellwarstone, manacrypt]
                },
                gifs: [alucard, alucard, alucard, alucard]
            },
            {
                //Ruleta
                id: 3,
                data: {
                    //Las palabras tienen que estar en el mismo index que la imagen correspondiente
                    palabras: ['Azusa, Lost but Seeking', 'Seedborn Muse', 'Fellwar Stone', 'Mana Crypt'],
                    imagenes: [azusa, seedbornmuse, fellwarstone, manacrypt]
                },
                gifs: [alucard, alucard, alucard, alucard]
            },
            ...
            },
            {
                ...
                data: {
                    //Las palabras tienen que estar en el mismo index que la imagen correspondiente
                    palabras: ['Azusa, Lost but Seeking', 'Seedborn Muse', 'Fellwar Stone', 'Mana Crypt', 'Omnath, Locus of Mana', 'Ornithopter'],
                    imagenes: [azusa, seedbornmuse, fellwarstone, manacrypt, omnath, ornithopter]
                },
                gifs: [alucard, alucard, alucard, alucard, alucard, alucard]
            },
        ]
    },
]
