...
export const NavbarGroupButton = ({ classNames, title, open }) => {
    return (
        <Popover.Button
        ...
        >
            ...
            <ChevronDownIcon
                className={classNames(
                    open ? 'text-teal-300' : 'text-gray-100 dark:text-gray-100',
...
export const NavbarProfileButton = ({ classNames, open }) => {
    return (
        <Popover.Button
            className={classNames(
        ...
        >
            ...
            <ChevronDownIcon
                className={classNames(
                    open ? ' text-teal-300 ' : 'text-gray-100 ',
                    'ml-2 h-5 w-5 group-hover:text-teal-300 mt-4'
                )}
                aria-hidden="true"
            />
        </Popover.Button>
